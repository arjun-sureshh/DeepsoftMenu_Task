...
const HomePage: React.FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    const fetchdata = async () => {
      try {
        await axios.get("https://deepsoft-menu-task-api.vercel.app/api/menu").then((response) => {
  ...
  useLayoutEffect(() => {
    ...
    const fetchfooditems = async () => {
      try {
        await axios.get("https://deepsoft-menu-task-api.vercel.app/api/food").then((response) => {
          console.log(response.data);
          if (response && response.status == 200 && response.data) {
